---
title: Non-Gaussian Emulation
output: rmarkdown::html_vignette
bibliography: references.bib 
description: >
  DGP emulation of the motorcycle accident data under a Heteroskedastic Gaussian Likelihood.
vignette: >
  %\VignetteIndexEntry{Non-Gaussian Emulation}
...
![](./images/motorcycle_data.png){width=100%}
...
<iframe src="htmls/motor_dgp.html" width="100%" height="410" style="border: none;"></iframe>
...
<iframe src="htmls/motor_gp.html" width="100%" height="410" style="border: none;"></iframe>
...
![](./images/motorcycle_gp_oos.png){width=100%}
...
![](./images/motorcycle_dgp_oos.png){width=100%}
