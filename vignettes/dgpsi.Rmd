...
In this guide we give a quick demonstration of the package on modeling the popular motorcycle dataset [@silverman1985]. There are other examples showing the functionality of the package in `Articles`, and a comprehensive Reference of available functions documented in `Reference`. 
