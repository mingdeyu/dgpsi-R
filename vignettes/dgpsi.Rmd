...
## Iteration 500: Layer 3: 100%|██████████| 500/500 [00:03<00:00, 127.33it/s]
```
...
## +-----------+----------+------------------+-----------------+---------------+-------------------+------------+-------------------+
## |  Layer 1  |  Node 1  | GP (Squared-Exp) |     [0.580]     | 1.000 (fixed) | 1.000e-06 (fixed) |    [1]     |        No         |
## |  Layer 2  |  Node 1  | GP (Squared-Exp) |     [0.753]     | 1.000 (fixed) | 1.000e-06 (fixed) |    [1]     |        [1]        |
## |  Layer 3  |  Node 1  | GP (Squared-Exp) |     [2.395]     |     0.476     | 1.000e-06 (fixed) |    [1]     |        [1]        |
## +-----------+----------+------------------+-----------------+---------------+-------------------+------------+-------------------+
...
```{r}
oos_x <- as.matrix(sample(seq(0, 1, length = 200),10))
oos_y <- as.matrix(sapply(oos_x, f))
```
