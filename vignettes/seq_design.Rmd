...
Note that to provide the simulator for the sequential design below, we have defined the above function such that its input `x` and output are both matrices. We now generate an initial design with 5 design points using the maximin Latin hypercube sampler:
